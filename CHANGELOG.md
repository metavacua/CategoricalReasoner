...
## 1.0.0
Reset the repository to a likely safe state and hopefully significantly clarified canonical methods and spec driven development architecture. Eliminated hopefully all the confusing context that allow LLMs to regenerate and preserve fundamentally broken behaviors.
