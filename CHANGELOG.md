...
- Updated GitHub Pages deployment to build from docs/dissertation, run build-and-deploy on pull requests, deploy to a PR-specific pages branch, and deploy to Pages only on main or manual runs
