...
- Updated GitHub Pages deployment to build from docs/dissertation, run build-and-deploy and deploy-pages on pull requests, and deploy on main/manual or candidate-* tags with auto-tagging
