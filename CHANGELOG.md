...
- Updated GitHub Pages deployment to build from docs/dissertation, run build-and-deploy and deploy-pages on pull requests, and deploy to Pages only on main or manual runs
