...
- Updated GitHub Pages deployment to build from docs/dissertation, run on pull requests (including build-and-deploy), and use a consistent site output directory
