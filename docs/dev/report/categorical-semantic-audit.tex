...
\addcontentsline{toc}{chapter}{Categorical Semantic Audit: RDF/OWL Schemas and Knowledge Graphs}
...
\begin{itemize}
  \item \texttt{Q719395}: Category (mathematics) \texttt{wd:Q719395}
  \item \texttt{Q864475}: Functor \texttt{wd:Q864475}
  \item \texttt{Q1442189}: Natural transformation \texttt{wd:Q1442189}
  \item \texttt{Q357858}: Adjoint functors \texttt{wd:Q357858}
\end{itemize}
...
\section{Categorical Morphisms and Structural Relevance}
...
\begin{itemize}
  \item \textbf{Full structural rules} (LK) allow for the validation of all classical principles.
  \item \textbf{Resource-sensitive rules} (LL) correspond to the absence of axioms related to cloning and erasure.
  \item \textbf{Sequent restrictions} (LHS/RHS) directly impact the validity of dual classical principles like LEM and LNC.
\end{itemize}
