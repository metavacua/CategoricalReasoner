...
\begin{itemize}
  ...
  \item Updated \texttt{.github/workflows/deploy.yml} to build from \texttt{docs/dissertation}, run build-and-deploy and deploy-pages on pull requests, deploy on main/manual events or candidate-* tags, emit site output to a consistent directory, and publish a bookshelf HTML stack for dissertation and structural rules.
  \item Added \texttt{.github/workflows/create-candidate-tag.yml} to push candidate-* tags for PRs, triggering protected deployments.
