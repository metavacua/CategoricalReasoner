...
\begin{itemize}
  ...
  \item Updated \texttt{.github/workflows/deploy.yml} to build from \texttt{docs/dissertation}, run build-and-deploy and deploy-pages on pull requests, deploy on main/manual events, emit site output to a consistent directory, and publish a bookshelf HTML stack for dissertation and structural rules.
