...
\begin{itemize}
  ...
  \item Updated \texttt{.github/workflows/deploy.yml} to build from \texttt{docs/dissertation}, run preview builds on pull requests, deploy on non-PR events, and emit site output to a consistent directory.
