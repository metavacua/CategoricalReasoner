...
\begin{itemize}
  ...
  \item Updated \texttt{.github/workflows/deploy.yml} to build from \texttt{docs/dissertation}, run build-and-deploy on pull requests, deploy to PR-specific pages branches, deploy on main/manual events, emit site output to a consistent directory, and publish a bookshelf HTML stack for dissertation and structural rules.
