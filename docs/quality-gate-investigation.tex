...
\begin{itemize}
  ...
  \item Added LaTeX fallbacks for linear logic notation, moved \texttt{xcolor} to the dissertation preamble, and corrected a table column count.
\end{itemize}

\subsection*{Verification}
\begin{itemize}
  \item TeX structure validation: \textbf{failed locally} due to missing \texttt{pyyaml} dependency.
    \begin{itemize}
      \item Command: \texttt{python src/schema/validators/validate\_tex\_structure.py --main-tex docs/dissertation/main.tex}
      \item Error: \texttt{PyYAML is required. Install with: pip install pyyaml}
    \end{itemize}
