...
\begin{itemize}
  ...
  \item Updated \texttt{.github/workflows/deploy.yml} to build from \texttt{docs/dissertation}, run preview builds on pull requests, deploy on non-PR events, emit site output to a consistent directory, and publish a bookshelf HTML stack for dissertation and structural rules.
