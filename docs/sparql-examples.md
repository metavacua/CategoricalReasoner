...
```bash
arq --data ../src/ontology/catty-categorical-schema.jsonld \
    --data ../src/ontology/logics-as-objects.jsonld \
    --data ../src/ontology/morphism-catalog.jsonld \
    --query all-logics.rq \
    --results csv
```
...
# Load the ontology
g = Graph()
g.parse("../src/ontology/catty-categorical-schema.jsonld", format="json-ld")
g.parse("../src/ontology/logics-as-objects.jsonld", format="json-ld")
g.parse("../src/ontology/morphism-catalog.jsonld", format="json-ld")
