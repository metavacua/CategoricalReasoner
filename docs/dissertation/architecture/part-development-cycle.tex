...
\begin{enumerate}
    ...
    \item \textbf{Content Validation}: Verify the artifact satisfies its \code{content_spec}.
...
\begin{itemize}
    \item ✅ \textit{Testable}: "File \code{src/ontology/logics-as-objects.jsonld} exists."
    \item ✅ \textit{Testable}: "Contains at least 7 logic instances."
    \item ✅ \textit{Testable}: "Validates against \code{logics-as-objects.shacl}."
\end{itemize}
